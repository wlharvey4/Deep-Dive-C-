...
* Section---Compiler and IDE
:PROPERTIES:
:Length:   11 minutes
:Lectures: 4
:Section:  4
:Section-Name: Compiler and IDE
:END:

#+include: ./Lectures/Section_04-Compiler_and_IDE_Setup/13.Install_Compiler.org
#+include: ./Lectures/Section_04-Compiler_and_IDE_Setup/14.Setup_CodeBlocks.org
#+include: ./Lectures/Section_04-Compiler_and_IDE_Setup/15.Setup_Dev-C++.org
#+include: ./Lectures/Section_04-Compiler_and_IDE_Setup/16.Setup_xcode.org
...
:Quizzes:  1
:END:
[[file:Lectures/Section_05-C++_Basics/17.Skeleton_of_C++_Program.org][Skeleton of a C++ Program]]

#+include: ./Lectures/Section_05-C++_Basics/17.Skeleton_of_C++_Program.org
#+include: ./Lectures/Section_05-C++_Basics/18.Writing_My_First_Program.org
#+include: ./Lectures/Section_05-C++_Basics/19.Demo---First_Program.org
#+include: ./Lectures/Section_05-C++_Basics/20.Why_Data_Types.org
#+include: ./Lectures/Section_05-C++_Basics/21.Primitive_Data_Types.org
